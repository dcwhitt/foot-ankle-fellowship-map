...
const details: Record<string, Partial<Program>> = {
  ...
  duke: { faculty: ["Samuel Adams, MD", "Annunziato Amendola, MD", "Cesar de Cesar Netto, MD, PhD", "Andrew Hanselman, MD", "James Nunley, MD", "Karl Schweitzer, MD"], focus: ["Total ankle replacement", "Forefoot", "Hindfoot", "Reconstruction", "Biomechanics"], stipend: "$86,292 (2026–27 PGY-6; Duke states orthopaedic fellows are paid at PGY-6)", stipendSource: "https://gme.duke.edu/training-programs/applicants/stipends/physician-trainee-stipends" },
  emory: { faculty: ["Jason Bariteau, MD", "Michelle Coleman, MD, PhD", "John Louis-Ugbo, MD"], focus: ["Trauma", "Forefoot", "Hindfoot", "Deformity"], stipend: "$87,023 (2026–27 institutional PGY-6 rate; confirm fellowship appointment level)", stipendSource: "https://med.emory.edu/education/gme/housestaff/index.html", research: "Two projects are expected, with submission to the AOFAS Annual Meeting and eventual publication as goals." },
  ...
  harvardmgb: { faculty: ["Eric Bluman, MD, PhD", "Christopher Chiodo, MD", "Christopher DiGiovanni, MD", "Amgad Haleem, MD, PhD", "John Kwon, MD", "Christopher Miller, MD", "Gregory Waryasz, MD", "Lorena Bejarano-Pineda, MD", "Daniel Guss, MD, MBA", "Elizabeth Martin, MD"], focus: ["Total ankle replacement", "Trauma", "Minimally invasive", "Deformity", "Biomechanics"], stipend: "$106,612 PGY-6 base (2026–27); most MGB GME programs also receive a $10,500 supplemental stipend—confirm program eligibility", stipendSource: "https://research.massgeneralbrigham.org/en/education-and-training/graduate-medical-education/current-trainees" },
  hss: { faculty: ["Steve Behrens, MD", "Elizabeth Cody, MD", "Jonathan Deland, MD", "Constantine Demetracopoulos, MD", "Andrew Elliott, MD", "Scott Ellis, MD", "Holly Johnson, MD", "David Levine, MD", "Martin O'Malley, MD", "Matthew Roberts, MD"], focus: ["Trauma", "Reconstruction", "Pediatrics", "Deformity"], stipend: "$124,500 (HSS 2026–27 PGY-6 rate; confirm with foot & ankle fellowship)", stipendSource: "https://www.hss.edu/education-institute/academic-training/fellowships/rheumatology-fellowship", research: "Two research projects and two manuscripts are expected by the end of the academic year." },
  ...
  colorado: { director: "Kenneth Hunt, MD", positions: 2, faculty: ["Courtney Grimsrud, MD", "Joshua Metzl, MD", "Daniel Moon, MD, MS, MBA", "Mark Myerson, MD"], focus: ["Trauma", "Reconstruction"], stipend: "$97,824.22 base (2026–27 institutional PGY-6 rate; confirm fellowship appointment level)", stipendSource: "https://medschool.cuanschutz.edu/graduate-medical-education/for-residents-and-fellows/stipends" },
  ...
  upenn: { director: "Bobby Ndu, MD", positions: 2, faculty: ["Lorraine Boakye, MD", "Wen Chao, MD", "Daniel Farber, MD", "Casey Humbyrd, MD, MBE", "L. Scott Levin, MD"], focus: ["Trauma", "Arthroscopy", "Reconstruction", "Deformity", "Biomechanics"], stipend: "$94,558.04 through Sept. 2026; $97,394.78 effective Oct. 1, 2026 (institutional PGY-6 rate)", stipendSource: "https://departments.med.upenn.edu/academic-departments/department-of-surgery/education-and-training/about-us/policies-and-procedures", eligibility: "Accepts graduates of US and Canadian residency programs." },
  pitt: { positions: 3, faculty: ["Stephen Conti, MD", "MaCalus Hogan, MD, MBA", "Christopher Edwards, MD", "Lauren Lewis, MD", "William Saar, DO"], focus: ["Adult foot & ankle surgery"], stipend: "$84,281 (UPMC 2026–27 PGY-6 rate; confirm fellowship appointment level)", stipendSource: "https://www.upmc.com/healthcare-professionals/education/gme/benefits" },
  rochester: { director: "David J. Ciufo, MD", faculty: ["Benedict DiGiovanni, MD", "A. Samuel Flemister, MD", "John Ketz, MD"], focus: ["Adult foot & ankle surgery"], stipend: "$90,730 (2026–27 institutional PGY-6 rate; confirm fellowship appointment level)", stipendSource: "https://www.urmc.rochester.edu/education/graduate-medical-education/prospective-fellows/endocrinology/program-highlights/benefits-contract", eligibility: "See the program's linked GME applicant eligibility requirements." },
  ...
  utah: { director: "Devon Nixon, MD", faculty: ["Florian Nickisch, MD", "Megan Campbell, MD"], focus: ["Trauma", "Sports medicine", "Reconstruction", "Minimally invasive", "Deformity"], stipend: "$91,863 (2026–27 institutional training-level 6 rate; confirm fellowship appointment level)", stipendSource: "https://medicine.utah.edu/sites/g/files/zrelqx296/files/media/documents/2026/fy27-trainee-stipend-memo.pdf" },
  virginia: { director: "M. Truitt Cooper, MD", faculty: ["Joseph Park, MD"], focus: ["Total ankle replacement", "Trauma", "Sports medicine", "Arthroscopy", "Reconstruction", "Deformity"], stipend: "$82,390 (2026–27 institutional PGY-6 rate; confirm fellowship appointment level)", stipendSource: "https://med.virginia.edu/gme/resources/community/stipendsbenefits/" },
  washington: { director: "David Dalstrom, MD", positions: 3, faculty: ["Stephen Benirschke, MD", "Kenneth Chin, MD", "Bruce Sangeorzan, MD"], focus: ["Trauma", "Sports medicine", "Reconstruction"], stipend: "$98,160 salary plus $10,000 allowance (UW AY27 R6 schedule; confirm appointment level)", stipendSource: "https://sites.uw.edu/uwgme/finance/orientation-rates/", research: "The weekly experience includes protected research time and teaching conferences." },
  ...
  washu: { director: "Jeremy McCormick, MD", faculty: [], focus: ["Trauma"], stipend: "$88,091 (2026–27 institutional PGY-6 rate; confirm fellowship appointment level)", stipendSource: "https://gme.wustl.edu/policies-procedures/stipends/" },
};
